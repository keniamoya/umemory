var symbols = ['bicycle', 'bicycle', 'leaf', 'leaf', 'cube', 'cube', 'anchor', 'anchor'],
    opened = [],
    match = 0,
    moves = 0,
    $deck = $('.deck'),
    ...
    delay = 800,
    gameCardsQTY = symbols.length / 2, //4
    rank3stars = gameCardsQTY - 3, //1 2m  
    rank2stars = gameCardsQTY - 1, //3 4m 
    rank1stars = gameCardsQTY + 1; //5 6m  
...
function setRating() {
    if ((moves - match) == 2) { //2 moves
        $ratingStars.eq(2).removeClass('fa-star').addClass('fa-star-o');
        rating = 2;
        questionLevel1();
    } else if ((moves - match) == 4) { //4 moves
